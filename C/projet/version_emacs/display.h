/*
	Module contenant tous les outils pour gerer l'affichage de menu et d'une partie de memory.
...
/*
	Structure contenant toutes les données necessaires à l'affichage de la partie.
		...
		-hide_next_move : lors d'une verification de coup, enregistre si les deux cartes doivent être retournées faces cachée
						  au prochain coup.		
		-card1Widget, card2Widget : buffers contenant les widgets des cartes cliquées par le joueur. 
